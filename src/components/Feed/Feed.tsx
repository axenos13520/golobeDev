                ...
                <div className="mt-20 mb-6 flex flex-row justify-between items-center w-[87%] mx-auto">
                    <div>
                        ...
                        <p className="opacity-70">
                            ...
                            you’re going home or somewhere to roam, we’ve got
                            the travel tools to get you to your <br />
                            destination.
                        </p>
                    </div>
                    <button className="px-4 py-2 border-2 border-solid border-emerald-200/70 rounded-md hover:bg-emerald-200 transition-colors duration-300">
                    ...
                    <div className="relative p-6 bg-[#8DD3BB] rounded-3xl row-start-1 row-end-3">
                        <div className="mb-6 flex flex-row justify-between">
                            ...
                            <div className="bg-white w-[68px] h-[62px] text-center rounded-lg">
                                <p className="mt-1 text-green-950">From</p>
                        ...
                        <p className="text-green-950">
                            Traveling is a unique experience as it's the best
                            way to unplug from the pushes and pulls of daily
                            life. It helps us to forget about our problems,
                            frustrations, and fears at home. During our journey,
                            we experience life in different ways. We explore new
                            places, cultures, cuisines, traditions, and ways of
                            living.
                        </p>
